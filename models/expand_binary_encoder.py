...
class expandBinaryEncoder(nn.Module):
    '''
    Analysis net
    '''
    def __init__(self, out_channel_N=192):
        super(expandBinaryEncoder, self).__init__()
        ...
        self.Bconv3 = nn.Conv2d(out_channel_N, out_channel_N, 3, stride=1, padding=1)
